    ...
    def backward(self):
        ...
        if current_angle != 0:
            ...
            if (current_angle / abs_current_angle) > 0:
                self.set_motor_speed(1, -1*self.speed)
                self.set_motor_speed(2, self.speed * power_scale)
            else:
                self.set_motor_speed(1, -1*self.speed * power_scale)
                self.set_motor_speed(2, self.speed )
        else:
            self.set_motor_speed(1, -1*self.speed)
            self.set_motor_speed(2, self.speed)  
    ...
    def forward(self):
        ...
        if current_angle != 0:
            ...
            if (current_angle / abs_current_angle) > 0:
                ...
                self.set_motor_speed(1, self.speed)
                self.set_motor_speed(2, -1*self.speed * power_scale)
                # print("current_speed: %s %s"%(speed, -1*speed * power_scale))
        else:
            self.set_motor_speed(1, self.speed)
            self.set_motor_speed(2, -1*self.speed)                  
